    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('GAMER', 'Gamer'), ('DEVELOPER', 'Developer'), ('PUBLISHER', 'Publisher'), ('STAFFMEMBER', 'StaffMember'), ('ADMIN', 'Admin')], default='ADMIN', max_length=50, verbose_name='Type')),
